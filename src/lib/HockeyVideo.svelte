<script lang="ts">
  let { videoId, title, kind = 'highlights', onclose }: { videoId: string; title: string; kind?: 'highlights' | 'replay'; onclose: () => void } =
    $props();
...
<div class="video-card">
  ...
  <p class="credit">{kind === 'replay' ? 'Replay intégral' : 'Résumé vidéo'} — FIH Hockey (YouTube)</p>
</div>
